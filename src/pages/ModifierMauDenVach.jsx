...
const ModifierMauDenVach = () => {
    ...
    useEffect(() => {
        const getNhan = async () => {
            await axios
                .get(`https://ptht.onrender.com/api/${type}/qlmau/${id}`)
                .then((e) => {
                    setMau(e.data.data);
                    console.log(e.data);
                })
    ...
    const handleAdd = async () => {
        await axios({
            method: "post",
            url: `https://ptht.onrender.com/api/${type}/qlmau`,
            data: {
                image: mau.image,
    ...
    const handleUpdate = async () => {
        await axios({
            method: "patch",
            url: `https://ptht.onrender.com/api/${type}/qlmau/${id}`,
            data: {
                image: mau.image,
                description: mau.description,
            },
            ...
            <div className="flex justify-center">
                <div className="w-[600px] bg-[#435b6ab0] pb-[20px] rounded-[4px]">
                    ...
                    <div className="px-[30px] py-[20px]">
                        <div className="flex">
                            <label className="font-semibold w-[120px]">Image:</label>
                            <input
                                type="file"
                                onChange={(e) => setMau((prev) => ({ ...prev, image: e.target.files[0] }))}
                                multiple
                        ...
                        {mau.image && (
                            <div className="flex justify-center">
                                <img
                                    src={mau.image === Object(mau.image) ? URL.createObjectURL(mau.image) : mau.image}
                                    alt="IMG preview"
...
export default ModifierMauDenVach;
