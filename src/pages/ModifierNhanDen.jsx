...
const ModifierNhanDen = () => {
    ...
    useEffect(() => {
        const getNhan = async () => {
            await axios
                .get(`https://ptht.onrender.com/api/den/qlnhan/${id}`)
                .then((e) => {
                    setBien(e.data.data);
                })
                .catch((e) => {});
    ...
    const handleAdd = async () => {
        await axios
            .post(`https://ptht.onrender.com/api/den/qlnhan`, bien)
            .then((e) => {
    ...
    const handleUpdate = async () => {
        await axios
            .patch(`https://ptht.onrender.com/api/den/qlnhan/${id}`, bien)
            .then((e) => {
                setMess(`${action} thành công!!`);
                setBien({
                    dendo: "",
    ...
    return (
        <div>
            <span className="block text-center w-full mt-[20px] text-[40px] font-semibold">
                {action} nhãn đèn giao thông
            </span>
            ...
            <div className="flex justify-center">
                <div className="w-[600px] bg-[#435b6ab0] pb-[20px] rounded-[4px]">
                    <div className="flex justify-center items-center  px-[30px] py-[20px]">
                        <label for="dendo" className="font-semibold w-[160px]">
                            Đèn đỏ
                        </label>
                        <input
                            type="text"
...
export default ModifierNhanDen;
